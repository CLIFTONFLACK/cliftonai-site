/**
 * Inline SVG icons for /healthy (paths from Lucide, ISC licence).
 *
 * These replace the Material Symbols icon font. That font rendered each icon
 * from a ligature word, so screen readers announced "arrow_forward" or
 * "verified" inside link names, and on a slow connection the raw words showed
 * on the page until the font arrived. SVG has neither problem and needs no
...
/** Decorative only: always hidden from assistive tech, so it never leaks into a link's name. */
